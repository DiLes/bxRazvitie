...
?>
<div class="catalog catalog-section-list">
...
//$_REQUEST['dev']=='Y'?'bootstrap_v4':'catalog';
$APPLICATION->IncludeComponent(
	"bitrix:catalog.section.list",
    $_REQUEST['dev']=='Y'?'bootstrap_v5':'catalog',
	$sectionListParams,
	$component,
...
{
	$APPLICATION->IncludeComponent("bitrix:catalog.compare.list", "catalog", array(
			"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
			"IBLOCK_ID" => $arParams["IBLOCK_ID"],
