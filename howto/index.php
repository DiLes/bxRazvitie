...
?>
<div class="container white deli_con">
    <h2>Процедура покупки товара в нашем Интернет-магазине очень проста и состоит из нескольких шагов.</h2>
    <div class="container white deli_con instruction_block">
        <div class="tabs-container">
            <div class="tabs">
                <div class="tab active" data-target="oformleniye"><span></span> Оформление заказа</div>
                <div class="tab" data-target="podtverzhdeniye"><span></span> Оформление и подтверждение заказа</div>
                <div class="tab" data-target="oplata"><span></span> Оплата и цены</div>
            </div>
            <div class="content-container">
                <div class="content active" id="oformleniye">
                ...
                <div class="content" id="podtverzhdeniye">
